use crate::{
    AppError, AppResult, Cli, providers,
...
pub async fn process_prompt(cli: &Cli) -> AppResult<()> {
...
// pub async fn old_process_prompt(cli: &Cli, streamer: &mut impl OutputStreamer) -> AppResult<()> {
//     streamer
